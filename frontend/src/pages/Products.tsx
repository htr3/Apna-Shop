              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {!product.quantity || product.quantity === 0 ? (
                    ...
                    <span className="bg-red-100 text-red-700 text-xs font-bold px-2.5 py-0.5 rounded">
                      Low Stock
                    </span>
                  ) : (
                      ...
                      <span
                        className={
                          (product.quantity ?? 0) < LOW_STOCK_THRESHOLD
                            ? "bg-red-50 px-3 py-1 rounded text-red-600 font-bold"
                            : "bg-blue-50 px-3 py-1 rounded text-blue-700 font-semibold"
                        }
                      >
